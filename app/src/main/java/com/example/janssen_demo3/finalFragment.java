package com.example.janssen_demo3;
...
public class finalFragment extends Fragment {
    ...
    //TK - Do a light effect here on the device and then turn all LEDs off to signify finishing
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState){
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_finalFragment_to_tenthFragment);
            }
        });

        // NEXT BUTTON FOR THIRD PAGE
        Button button2 = view.findViewById(R.id.button2);
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_finalFragment_to_firstFragment);
            }
        });
    }
