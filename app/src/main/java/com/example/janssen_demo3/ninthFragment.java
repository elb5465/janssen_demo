...
public class ninthFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState){
        ...
        // BACK BUTTON FOR NINTH PAGE
        Button button1 = view.findViewById(R.id.button1);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_ninthFragment_to_eighthFragment);
            }
        });

        // NEXT BUTTON FOR NINTH PAGE
        Button button2 = view.findViewById(R.id.button2);
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_ninthFragment_to_tenthFragment);
            }
        });
    }
}